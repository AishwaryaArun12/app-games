...
function App() {
  ...
  useEffect(()=>{
    async function fetchData(){
      const url="https://api.rawg.io/api/games?key=a5b6d39b1e624a97b6e81402205fb2d2";
  ...
  async function search(evt){
    evt.preventDefault();
    if(searchValue){
    const searchUrl="https://api.rawg.io/api/games?key=a5b6d39b1e624a97b6e81402205fb2d2&search="
  ...
  return (
    <div className="App">
      ...
      <div>Order by:  <select onChange={async (e)=>{
            var option='';
          ...
          const url="https://api.rawg.io/api/games?key=a5b6d39b1e624a97b6e81402205fb2d2&ordering=-";
     ...
     <div className='Game'>
      {result.map((game)=>{
        return (
          ...
          <div className='headingDiv'><h3>{game.name}</h3><div className='ratingDiv'>{game.rating}</div>
